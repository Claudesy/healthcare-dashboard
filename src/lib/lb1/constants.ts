...
export const CANONICAL_COLUMNS: Record<string, string[]> = {
  ...
  dx_code:    ["KODEDIAGNOSE", "KODEDIAGNOSA", "KODEDX", "DX", "ICD10", "ICD", "DIAGNOSA1", "DIAGNOSIS1"],
  sex:        ["SEX", "LP", "L/P", "JK", "JENISKELAMIN"],
  visit_type: ["KBKL", "KB/KL", "JENISKUNJUNGAN", "KUNJUNGANBARULAMA", "STATUSKUNJUNGAN", "KUNJUNGAN"],
};
...
export const SEX_MAP: Record<string, "L" | "P"> = {
  L: "L", LAKI: "L", LAKILAKI: "L", "LAKI-LAKI": "L", M: "L",
  P: "P", PR: "P", PEREMPUAN: "P", F: "P", W: "P",
};

export const VISIT_MAP: Record<string, "KB" | "KL"> = {
  KB: "KB", BARU: "KB", KUNJUNGANBARU: "KB",
  KL: "KL", LAMA: "KL", KUNJUNGANLAMA: "KL",
};
