...
export const ICD_MAP: Record<string, IcdEntry> = {
  ...
  "J00":   { code: "J00",    name: "Nasofaringitis Akut (Pilek)",   category: "rawat-jalan" },
  "J06":   { code: "J06",    name: "Infeksi Sal. Napas Atas Akut",  category: "rawat-jalan" },
  ...
  // Diabetes
  "E11":   { code: "E11",    name: "Diabetes Melitus Tipe 2",       category: "rawat-jalan" },
  "E11.9": { code: "E11.9",  name: "DM Tipe 2 tanpa Komplikasi",    category: "rawat-jalan" },
  ...
  "A16.9": { code: "A16.9",  name: "Tuberkulosis Paru",             category: "rawat-jalan" },

  // Muskuloskeletal
  "M79.3": { code: "M79.3",  name: "Mialgia",                       category: "rawat-jalan" },
  "M54.5": { code: "M54.5",  name: "Nyeri Punggung Bawah",          category: "rawat-jalan" },
  ...
  "F41.1": { code: "F41.1",  name: "Gangguan Ansietas",             category: "rawat-jalan" },
  ...
  // Anak
  "A08.0": { code: "A08.0",  name: "Gastroenteritis Rotavirus",     category: "rawat-jalan" },
  "P07.3": { code: "P07.3",  name: "Bayi Prematur",                 category: "rujuk" },

  // Lain-lain
  "Z00.0": { code: "Z00.0",  name: "Pemeriksaan Umum",              category: "rawat-jalan" },
  "Z34":   { code: "Z34",    name: "Pengawasan Kehamilan Normal",   category: "rawat-jalan" },
...
export function lookupIcd(code: string): IcdEntry | null {
  ...
  // prefix match
  const found = Object.values(ICD_MAP).find((e) => clean.startsWith(e.code) || e.code.startsWith(clean));
  return found ?? null;
}
