  ...
  if (error || !appointment) {
    return (
      ...
      >
        ...
        <h2 style={{ color: "var(--text-main)", fontSize: 20, marginBottom: 8 }}>Appointment Tidak Ditemukan</h2>
  ...
  if (sessionComplete) {
    return (
      ...
      >
        ...
        <h2 style={{ color: "var(--text-main)", fontSize: 22, marginBottom: 8 }}>Konsultasi Selesai</h2>
      ...
      >
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
          ...
          <span style={{ color: "rgba(255,255,255,0.4)", fontSize: 12 }}>
            · {new Date(appointment.scheduledAt).toLocaleString("id-ID", { dateStyle: "short", timeStyle: "short" })}
          </span>
        </div>
      </div>
