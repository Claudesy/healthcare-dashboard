...
// src/lib/telemedicine/notifications.ts
// ============================================================
...
/**
 * Kirim notifikasi WhatsApp ke pasien via WhatsApp Cloud API.
 * Gunakan template yang sudah diapprove oleh Meta.
 */
export async function sendWhatsAppNotification(
  ...
  if (!WHATSAPP_TOKEN || !WHATSAPP_PHONE_ID) {
    console.warn("[WhatsApp] Konfigurasi WhatsApp belum diset");
    return;
  }
  ...
  const message = {
    ...
    type: "template",
    template: {
      name: "pkm_appointment_reminder", // Template sudah diapprove Meta
      language: { code: "id" },
      components: [
        {
          type: "body",
...
/**
 * Kirim reminder H-1 jam sebelum jadwal.
 * Dipanggil oleh cron job / queue worker.
 */
